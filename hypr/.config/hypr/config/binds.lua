...
-- Added by me because I did not like the loop it was doing, so I wrote it out manually. 
hl.bind(mainMod .. " + SHIFT + ALT + 1", hl.dsp.window.move({ workspace = "1" }))
hl.bind(mainMod .. " + SHIFT + ALT + 2", hl.dsp.window.move({ workspace = "2" }))
hl.bind(mainMod .. " + SHIFT + ALT + 3", hl.dsp.window.move({ workspace = "3" }))
hl.bind(mainMod .. " + SHIFT + ALT + 4", hl.dsp.window.move({ workspace = "4" }))
hl.bind(mainMod .. " + SHIFT + ALT + 5", hl.dsp.window.move({ workspace = "5" }))
hl.bind(mainMod .. " + SHIFT + ALT + 6", hl.dsp.window.move({ workspace = "6" }))
hl.bind(mainMod .. " + SHIFT + ALT + 7", hl.dsp.window.move({ workspace = "name:gaming" }))
...
-- User added launcher shortcuts
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(launchPrefix .. "vesktop"))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd(launchPrefix .. "joplin-desktop"))
...
hl.bind(mainMod .. " + ALT + 7", hl.dsp.focus({workspace = "name:gaming"}))
